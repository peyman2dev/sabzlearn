          ...
          ? _.map(menus, (menu, index) =>
              menu.submenus.length ? (
                <li key={index} className="group relative">
                  ...
                  <ul className="absolute z-[11] border-t dark:border-t-white/10 space-y-3 p-4 opacity-0 invisible duration-300 group-hover:visible group-hover:opacity-100 w-[246px] rounded-lg bg-white dark:bg-dark-600 shadow-md ">
