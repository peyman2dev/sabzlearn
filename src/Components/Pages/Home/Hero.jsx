...
export default function Hero() {
  ...
  return (
    <section className="my-[100px] flex-col-reverse child:w-full lg:justify-between gap-6 lg:flex-row text-center w-[95%] mx-auto lg:text-start justify-center lg:pr-[215px] flex items-center">
      <div>
        ...
        <div className="mt-6 flex items-center  duration-150 gap-4">
